  ...
  return (
    ...
    >
      ...
      <div className="flex mx-2 justify-between items-center">
        <div className="text-xs text-black hidden sm:block">www.chatbot.com</div>
          ...
          {initialIndex === 0 ? (
            <>
              <div className="flex items-center justify-between">
                <div className="text-[#1E255E] capitalize text-lg sm:text-xl font-medium text-center ">{tab}</div>
                    ...
                    <TableRow>
                      ...
                      <TableHead className="py-2 text-center w-[20%] md:w-[20%]">
                        <div className="flex items-center flex-wrap justify-center gap-1">
                          <span className="text-[#1E255E] font-medium">Last Edited</span>
                        </div>
                      </TableHead>
                      <TableHead className="py-2 text-center w-[20%] md:w-[20%]">
