...
const AIKnowledge = ({
  ...
  const updateHandler = async () => {
    if (tab === "documents" && listOfDocument.length === 0) {
      ...
      const data = {
        chatbotId: chatbotId,
        details: tab === "documents" ? { documentContent: listOfDocument } : { websiteContent: listOfWebsites },
      };
      onUpdate(data);
    }
  };
  ...
  const handleChangeWebsite = async () => {
    ...
    try {
      ...
      await axiosInstance.put(`/chatbot/${chatbotId}/updateWebsite`, dataObject);
      toast.success("ChatBot Updated successfully");
      refetchTrainData();
      setOpenDomainChange(false);
    } catch (err) {
    ...
    >
      ...
      <div className="flex mx-2 justify-between items-center">
        <div className="flex gap-2 sm:gap-4">
          ...
          <Dialog open={openDomainChange} onOpenChange={setOpenDomainChange}>
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                <DialogTitle>Change the Website Associated with Chatbot</DialogTitle>
                <DialogDescription>
                  Updating the domain below will replace the current website linked to your chatbot. Please enter the
                  new website URL where you intend to deploy the bot.
                </DialogDescription>
              </DialogHeader>
              ...
              <DialogFooter>
                <Button
                  ...
                  disabled={loading}
                  className="w-fit text-white bg-[#232323] hover:bg-[#232323] px-4 py-1 sm:py-2 rounded-lg"
                >
