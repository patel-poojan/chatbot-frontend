...
const ButtonInteractionDialog = ({
  ...
  const handleSave = () => {
    ...
    const updatedData = {
      ...
      phoneNumber: tempButton.type === "phoneNumber" ? tempButton.navigationInfo : "",
        ...
        <div className="p-3 bg-white flex flex-col gap-2">
          ...
          <div className="w-full">
            ...
            <div className="w-full !mt-1">
              <Select value={tempButton.type} onValueChange={(value) => handleTempUpdate("type", value)}>
          ...
          {tempButton.type === "message" ? (
            <div className="w-full">
              <label htmlFor="message" className="text-black font-normal text-sm">
                Button message
              </label>
              <Input
                value={tempButton.navigationInfo}
                onChange={(e) => handleTempUpdate("navigationInfo", e.target.value)}
                id="message"
                className="p-2 mt-1 placeholder:text-xs border border-gray-200 bg-white hover:ring-1 hover:ring-[#57C0DD] rounded-md focus:outline-none focus-visible:border-[#57C0DD] focus-visible:ring-1 focus-visible:ring-[#57C0DD] shadow-sm transition duration-200"
