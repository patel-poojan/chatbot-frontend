...
export const LlmResponse = ({ info }: { info: ResponseInfo }) => {
  return (
    <pre
      className="resize-none border border-transparent text-sm bg-white p-3  rounded-md shadow-none focus:outline-none  focus-visible:ring-0 overflow-y-auto whitespace-break-spaces"
      style={{
