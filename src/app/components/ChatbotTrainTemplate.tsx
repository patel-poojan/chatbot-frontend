...
const ChatbotTrainTemplate = ({ type }: { type: string }) => {
  ...
  console.log("type", type, setStep, setWebsiteStep);
  const stepHandler = () => {
    setStep(step + 1);
  };
  ...
  return (
    <div className="w-full  max-w-7xl flex-1 mx-auto h-auto flex flex-col gap-8 sm:gap-11 ">
      <div className="w-fit md:mx-5 mx-auto">
        <div className="flex items-center  gap-1">
          ...
          <div className="w-24 sm:w-64 h-px bg-gray-300"></div>
          <div className="rounded-full p-2 w-8 h-8 flex items-center justify-center blue-gradient text-white">
            2
          </div>
        </div>
