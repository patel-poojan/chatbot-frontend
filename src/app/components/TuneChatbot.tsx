    ...
    if (!attributes[0].value) {
      ...
      if (botIcon && botIcon.startsWith("data:image")) {
        ...
        if (matches && matches.length === 3) {
          ...
          const iconFile = new File([blob], `chat_icon_${Date.now()}.${mimeType.split("/")[1]}`, { type: mimeType });
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-6 w-full overflow-hidden">
        <div className="w-full lg:w-3/5 flex-1 flex flex-col h-full overflow-y-auto overflow-x-hidden show-scrollbar pr-4">
          <div className="mb-4 sm:mb-6">
            <h2 className="text-black font-semibold text-2xl">Tune your ChatAgent</h2>
          ...
          <div className="mb-4 sm:mb-6 w-full">
            <p className="text-black font-normal text-lg mb-3">Upload Bot Icon</p>
            <div
            ...
            >
              ...
              {botIcon ? (
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-[#1E255EB2] text-sm">Click to change icon</p>
                </div>
              ) : (
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-[#1E255EB2] text-sm">Click to upload bot icon</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="hidden lg:w-2/5 overflow-y-auto lg:flex flex-col gap-3 border-t-[40px] rounded-[30px] border-r-[40px] border-b-0 border-l-[40px] border-[#57C0DD] p-4 ">
          <div className="flex gap-3">
            ...
            <div className="flex flex-col my-1 justify-between min-w-0">
              <p className="text-[#1E255E] font-medium text-sm truncate">{attributes[0].value}</p>
          ...
          <div className="flex flex-col gap-2">
            {FAQ && <div className="text-center px-6 py-2 border rounded-xl border-[#57C0DD] text-[#57C0DD]">FAQ</div>}
            {AboutUs && (
            ...
            <SheetHeader>
              ...
              <SheetDescription className="flex pt-2 flex-col gap-4 overflow-y-auto show-scrollbar">
                ...
                <div className="flex flex-col gap-2 pb-4">
                  {FAQ && (
                    <div className="text-center px-6 py-2 border rounded-xl border-[#57C0DD] text-[#57C0DD]">FAQ</div>
                  )}
                  {AboutUs && (
                    <div className="text-center px-6 py-2 border rounded-xl border-[#57C0DD] text-[#57C0DD]">
                      About ChatAgent
