            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Link href={"/chatbotlist"}>
                  <div
                    className={`${
                      pathName === "/chatbotlist" || pathName === "/create" || pathName === "/dashboard"
                        ? "bg-[#3D3D4A]"
                        : "bg-transparent"
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Link href={"/training"}>
                  <div
                    className={`${
                      pathName === "/training" ? "bg-[#3D3D4A]" : "bg-transparent"
                    } hover:bg-[#3D3D4A] h-11 w-11 flex items-center justify-center rounded-md cursor-pointer`}
                  >
              ...
              <div className="h-full flex flex-col w-full bg-white pt-3">
                <div className="w-full  flex-1">
                  ...
                  <Link href={"/training"}>
                    ...
                    >
                      <div className={pathName === "/training" ? "p-2 rounded-md bg-[#3D3D4A33]" : ""}>
                        <MdOutlineQuickreply
                          className={pathName === "/training" ? "text-white text-xl" : "text-2xl text-[#1e255eb2]"}
                        />
                      </div>
                      <p
                        className={`text-base  ${
                          pathName === "/training" ? "text-white" : "text-[#1e255eb2]"
                        }  font-medium`}
                      >
                        Training
                      </p>
                    ...
                    <div className="flex justify-between items-center border-2 bg-[#e9e9e933] rounded-xl border-[#F3F3F3] p-2">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-start">
                          <p className="text-[#1e255eb2] font-medium text-base">User Name</p>
                          <p className="text-[#1e255eb2] font-light text-base">useremail123@gmail.com</p>
                        </div>
                      </div>
