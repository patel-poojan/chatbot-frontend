...
const DashboardLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const showUser =
    role === "admin" || (role !== "user" && !(role === "subadmin" && !permissions.includes("ACCESS_TO_USER_DATA")));
  const showBda =
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Link href={`/training/${chatbotId}`}>
                      <div
                        className={`${
                          pathName.includes("/training") ? "bg-[#3D3D4A]" : "bg-transparent"
                        } hover:bg-[#3D3D4A] h-11 w-11 flex items-center justify-center rounded-md cursor-pointer`}
                      >
                  ...
                  <div className="w-full  flex-1">
                    ...
                    {chatbotId && (
                      <Link href={`/training/${chatbotId}`}>
                        <div
                          className={`flex gap-3 items-center  rounded-lg py-3 ${
                            pathName.includes("/training") ? "px-3 blue-gradient" : ""
                          }`}
                        >
                          <div className={pathName.includes("/training") ? "p-2 rounded-md bg-[#3D3D4A33]" : ""}>
                            <MdOutlineQuickreply
                              className={
                                pathName.includes("/training") ? "text-white text-xl" : "text-2xl text-[#1e255eb2]"
                              }
                            />
                          </div>
                          <p
                            className={`text-base  ${
                              pathName.includes("/training") ? "text-white" : "text-[#1e255eb2]"
                            }  font-medium`}
                          >
                            Training
                          </p>
