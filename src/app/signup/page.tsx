    ...
    <div className="h-dvh w-dvw flex justify-center items-center">
      ...
      <div className="flex flex-col gap-4 md:gap-6 w-full max-w-lg px-4">
        <div className="flex flex-col gap-1 md:gap-2 justify-center items-center">
          ...
          <p className="text-black font-medium text-2xl md:text-[32px]">Sign Up</p>
        </div>
        ...
        <div className="text-center text-[#1E255EB2] ms-2 font-normal text-sm sm:text-base flex items-center">
          ...
          />
          I Agree to
          <Link href="/terms-of-use.pdf" target="_blank" className="text-[#57C0DD] cursor-pointer mx-1">
            Term of Use
          </Link>
          and
          <Link href="/privacy-policy.pdf" target="_blank" className="text-[#57C0DD] cursor-pointer mx-1">
            Privacy Policy
          </Link>
        </div>
        <Button
