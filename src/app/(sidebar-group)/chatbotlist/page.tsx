...
const Page = () => {
  ...
  return (
    <div className="flex-1 flex flex-col max-[500px]:p-4 overflow-auto">
      ...
      <div className="max-[500px]:text-xl text-2xl font-semibold text-black mb-6 max-[500px]:mb-4">ChatBots</div>
      <div className="flex-1 overflow-y-auto">
        <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
          ...
          >
            ...
            <div className="text-white mt-1 font-medium text-sm sm:text-base">Add chatbot</div>
          </div>
          {!errorInChatbotList &&
            chatbotList &&
