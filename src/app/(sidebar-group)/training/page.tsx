  ...
  return (
    <Table className="min-w-full table-fixed">
      <TableHeader className="bg-[#57C0DD1A] backdrop-blur-3xl sticky top-0">
        <TableRow>
          <TableHead>
            <div className="flex items-center justify-start gap-2">User Query</div>
          </TableHead>
          <TableHead>
          ...
          <TableRow key={index} className="hover:bg-gray-50">
            ...
            <TableCell>
              <div className="flex flex-wrap items-center justify-center gap-2">
                ...
                {type === "unmatched" && <div className="py-1 px-5 rounded-md bg-[#F59B521A]">Ignore</div>}
                <div className="py-1 px-5 rounded-md bg-[#FF02021A]">Delete</div>
              </div>
            </TableCell>
          </TableRow>
        ))}
  ...
  return (
    <div className="flex flex-1 overflow-hidden flex-col max-[500px]:p-4 gap-4 sm:gap-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <p className="text-xl sm:text-2xl font-semibold text-black">Training</p>
      ...
      <div className="flex-1 flex flex-col overflow-auto">
        {tab === 0 ? <TrainingTable type="unmatched" /> : <TrainingTable type="ignored" />}
      </div>
    </div>
  );
};
