...
const Page = ({ params }: { params: { id: string } }) => {
  ...
  return (
    <OuterTemplate>
      {step === 0 ? (
        <ChooseIndustryTemplate up={up} setIndustry={setIndustry} setSubIndustry={setSubIndustry} />
      ) : (
        <BDAQuestion down={down} type="website" industry={industry} subIndustry={subIndustry} chatBotId={params.id} />
      )}
    </OuterTemplate>
  );
};
